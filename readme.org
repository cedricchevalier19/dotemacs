...
#+BEGIN_SRC emacs-lisp
  (use-package tree-sitter
    ...
    :hook
    ((c-mode c++-mode python-mode yaml-mode json-mode) #'tree-sitter-mode)
    )
...
(use-package org
  ...
  (setq oxl-process-bibtex
        '("podman run --rm  -v .:/workdir danteev/texlive latexmk -pdflatex='pdflatex -interaction=nonstopmode -shell-escape' -synctex=1 -pdf -bibtex -f %f"))

  (setq oxl-process-biber
        '("podman run --rm  -v .:/workdir danteev/texlive latexmk -pdflatex='pdflatex -interaction=nonstopmode -shell-escape' -synctex=1 -pdf -biber -f %f"))

  (setq oxl-process-xelatex
        '("podman run --rm  -v .:/workdir danteev/texlive latexmk -pdf -synctex=1 -shell-escape -xelatex -f %f"))

  (setq oxl-process-lualatex
        '("podman run --rm  -v .:/workdir danteev/texlive latexmk -pdf -synctex=1 -shell-escape -lualatex -f %f"))
...
*** org-cv
From https://titan-c.gitlab.io/org-cv/

#+BEGIN_SRC emacs-lisp
(use-package ox-moderncv
  :load-path "~/.emacs.d/mirrors/org-cv")
#+END_SRC
